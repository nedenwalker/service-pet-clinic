...
```
tanzu apps workload create service-pet-clinic -f config/workload.yaml \
  --local-path . \
  --source-image <REPOSITORY-PREFIX>/service-pet-clinic-source \
  --type web
```
...
```
tanzu apps workload get service-pet-clinic
```
